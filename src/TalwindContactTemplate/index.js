...
export default function TalwindContactTemplate() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    phoneNumber: Yup.number().required("Zorunlu Alan"),
      ...
      <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            ...
            {errors.firstName && touched.firstName && <div className='inputErrorMessage'>{errors.firstName}</div>}
          </div>
          <div>
            ...
            {errors.lastName && touched.lastName && <div className='inputErrorMessage'>{errors.lastName}</div>}
          </div>
          <div className="sm:col-span-2">
            ...
            {errors.company && touched.company && <div className='inputErrorMessage'>{errors.company}</div>}
          </div>
          <div className="sm:col-span-2">
            ...
            {errors.email && touched.email && <div className='inputErrorMessage'>{errors.email}</div>}
          </div>
          <div className="sm:col-span-2">
            ...
            {errors.country && touched.country && <div className='inputErrorMessage'>{errors.country}</div>}
            {errors.phoneNumber && touched.phoneNumber && <div className='inputErrorMessage'>{errors.phoneNumber}</div>}
          </div>
          <div className="sm:col-span-2">
            ...
            {errors.message && touched.message && <div className='inputErrorMessage'>{errors.message}</div>}
          </div>
